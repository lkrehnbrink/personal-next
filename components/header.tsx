    ...
    return (
        <nav style={navStyle}>
            ...
            <div style={{textAlign: 'center'}}>
                ...
                <p><u>Front-end Web Dev</u><br/>with<br/><Counter startTime='2015-05-01T08:00:00-05:00'/><br/>of full stack web development experience.</p>
                <div style={{display: 'flex', gap: '1rem', justifyContent: 'center'}}>
                    <a href="https://www.linkedin.com/in/lew-krehnbrink-6184a239" target="_blank" title='Lew on linkedIn' rel="noreferrer">
                        <Image alt='LinkedIn Logo' {...linkedInIcon} width={imageSize} height={imageSize}/>
                    </a>
                    <a href="https://github.com/lkrehnbrink" target="_blank" title='Lew on github' rel="noreferrer">
                        <Image alt='Github Logo' {...githubIcon} width={imageSize} height={imageSize}/>
                    </a>
                </div>
            </div>
      </nav>
